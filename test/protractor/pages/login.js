...
var LoginPage = function (browser,account) {
	...
	this.get = function() {
		this.browser.driver.get('https://' + app_host + ':4072/');
	}

	this.login = function() {
		if (account == "primary") {
			this.browser.driver.get('https://' + app_host + ':4072/google/callback?code=1');
		} else {
			this.browser.driver.get('https://' + app_host + ':4072/google/callback?code=2');
		}
	}
